...
public class Lorry extends Vehicle{
    ...
    public Lorry(String text, String value, String txtMaxWeightText, String txtNoOfPassengersText) {
        super();
    }

    public Lorry(String vehicleNo, String vehicleType, int maximumWeight, int noOfPassengers) {
